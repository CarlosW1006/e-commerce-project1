...
<body style="background-color: 	#E0E0E0;">
    ...
    <!-- section start -->
	<% //jsp連接前端範例
							sql="select * from mouses where pid=5";
	...
	<section>
		<div class="container-fluid w-75">
				...
				<form class="produce" method="GET" action="addpro.jsp" style="padding-top:0px;">
					<div class="pro">
						...
						<div class="mt-5">
							...
							<input style="display:none;" name="pro" value="5">
			...
			<div class="prointro">
				...
				<hr style="clear:both; border: 1px solid #B3B492;">
				<p>商品展示：</p>
				<img class="intro" src="pic/g6032.jpg" alt="">
				<img class="intro" src="pic/g6033.jpg" alt="">
				<img class="intro" src="pic/g6035.jpg" alt="">&nbsp;&nbsp;&nbsp;&nbsp;
    			...
    			<p>深：43 公釐</p>
    			<p>重量：88.9 公克，僅滑鼠</p>
    			<p>112.3 公克(1顆3號AA電池)</p>
    			<p>135.7 公克(2顆3號AA電池)</p>
    			<div class="right">
    				<p>追蹤器</p>
    				<p>感應器：HERO™ </p>
    				<p>解析度：200 – 12,000 DPI </p>
    				<p>零濾波/加速/過濾 </p>
    				<p>最大加速：> 40 G</p>	
    				<p>最大速度：> 400 IPS</p>
    			</div>
			...
			<div class="like">
				...
				<div class="allclass">
					...
					<div class="aclass">
						<a href="p2.jsp"><img src="pic/product/g903.jpg" alt="" style="width:100%">
					...
					<div class="aclass">
						<a href="p6.jsp"><img src="pic/product/g305.jpg" alt="" style="width:100%">
							<div class="overlay" style="width:100%;">
								<div class="class" style="border:1px lightblue solid; padding:50px 100px;" title="G603">G304</div>
							</div>
						</a>
					</div>
				</div>
