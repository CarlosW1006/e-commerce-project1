...
<body style="background-color: 	#E0E0E0;">
    ...
    <!-- section start -->
	<% //jsp連接前端範例
							sql="select * from mouses where pid=4";
	...
	<section>
		<div class="container-fluid w-75">
				...
				<form class="produce" method="GET" action="addpro.jsp" style="padding-top:0px;">
					<div class="pro">
						...
						<div class="mt-5">
							...
							<input style="display:none;" name="pro" value="4">
			...
			<div class="prointro">
				...
				<hr style="clear:both; border: 1px solid #B3B492;">
				<p>商品展示：</p>
				<img class="intro" src="pic/pro1.jpg" alt="">
				<img class="intro" src="pic/pro2.jpg" alt="">
				<img class="intro" src="pic/pro3.jpg" alt="">&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<div class="like">
				...
				<div class="allclass">
					...
					<div class="aclass">
						<a href="product.jsp"><img src="pic/product/pro.jpg" alt="" style="width:100%">
							<div class="overlay" style="width:100%;">
								<div class="class" style="border:1px lightblue solid; padding:50px 100px;" title="G Pro Wireless">G Pro Wireless</div>
							</div>
						</a>
					</div>
					<div class="aclass">
						<a href="p3.jsp"><img src="pic/product/g502.jpg" alt="" style="width:100%">
							<div class="overlay" style="width:100%;">
					...
					<div class="aclass">
						<a href="p6.jsp"><img src="pic/product/g305.jpg" alt="" style="width:100%">
							<div class="overlay" style="width:100%;">
								<div class="class" style="border:1px lightblue solid; padding:50px 100px;" title="G603">G305</div>
							</div>
						</a>
					</div>
				</div>
				...
				<div class="col-md">
					<div class="block-23 mb-3" style="padding-top: 20px;"><br>
						<div class="row">
							...
							<div class="col">
								<a href="menu.html" class="leaf">Sales</a>
							</div>
						</div><br>
						<div class="row">
							<div class="col">
								<a href="about.html" class="leaf">About us</a>
							</div>
