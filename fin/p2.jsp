...
<body style="background-color: 	#E0E0E0;">
    ...
    <!-- section start -->
	<% //jsp連接前端範例
							sql="select * from mouses where pid=2";
	...
	<section>
		<div class="container-fluid w-75">
				...
				<form class="produce" method="GET" action="addpro.jsp" style="padding-top:0px;">
					<div class="pro">
						...
						<div class="mt-5">
							...
							<input style="display:none;" name="pro" value="2">
			...
			<div class="prointro">
				...
				<hr style="clear:both; border: 1px solid #B3B492;">
				<p>商品展示：</p>
				<img class="intro" src="pic/product/g903.jpg" alt="">
				<img class="intro" src="pic/g9032.jpg" alt="">
				<img class="intro" src="pic/g9033.jpg" alt="">&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<div class="aclass">
						<a href="product.jsp"><img src="pic/product/pro.jpg" alt="" style="width:100%">
							<div class="overlay" style="width:100%;">
								<div class="class" style="border:1px lightblue solid; padding:50px 100px;" title="G903">G Pro Wireless</div>
							</div>
						</a>
					</div>
					<div class="aclass">
