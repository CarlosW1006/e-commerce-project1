...
<body style="background-color: 	#E0E0E0;">
    ...
    <!-- section start -->
	<% //jsp連接前端範例
							sql="select * from mouses where pid=1";
		...
		<div class="container-fluid w-75">
				...
				<div class="rankall">
					...
					<%
						...
						while(rs.next())
						{
							...
							out.println("評論:"+rs.getString(3)+"<br>");
							out.println("時間:"+rs.getString(4)+"<br><hr>");
						}
					%>
					</h5>			
				</div>
			...
			<div class="like">
				...
				<div class="allclass">
					...
					<div class="aclass">
						<a href=""><img src="pic/product/g703.jpg" alt="" style="width:100%">
							<div class="overlay" style="width:100%;">
					...
					<div class="aclass">
						<a href=""><img src="pic/product/g603.jpg" alt="" style="width:100%">
							<div class="overlay" style="width:100%;">
