...
<body style="background-color: 	#E0E0E0;">
    ...
    <!-- section start -->
	<% //jsp連接前端範例
							sql="select * from mouses where pid=6";
	...
	<section>
		<div class="container-fluid w-75">
				...
				<form class="produce" method="GET" action="addpro.jsp" style="padding-top:0px;">
					<div class="pro">
						...
						<div class="mt-5">
							...
							<input style="display:none;" name="pro" value="6">
			...
			<div class="prointro">
				...
				<hr style="clear:both; border: 1px solid #B3B492;">
				<p>商品展示：</p>
				<img class="intro" src="pic/g3042.jpg" alt="">
				<img class="intro" src="pic/g3043.jpg" alt="">
				<img class="intro" src="pic/g3046.jpg" alt="">&nbsp;&nbsp;&nbsp;&nbsp;
